...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contact.height'
        db.add_column(u'hello_contact', 'height',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Contact.width'
        db.add_column(u'hello_contact', 'width',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Contact.height'
        db.delete_column(u'hello_contact', 'height')

        # Deleting field 'Contact.width'
        db.delete_column(u'hello_contact', 'width')
