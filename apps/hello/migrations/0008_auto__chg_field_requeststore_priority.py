...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'hello_requeststore', 'priority', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'RequestStore.priority'
        db.alter_column(u'hello_requeststore', 'priority', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        ...
        u'hello.requeststore': {
            ...
            'priority': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
